...
resource "aws_subnet" "public" {
  ...
  # IV-10 fix: no auto-assign public IPs
...
# IV-10 fix: private subnets for EKS nodes and RDS
...
# IV-10 fix: NAT gateway so private subnets can reach internet outbound
